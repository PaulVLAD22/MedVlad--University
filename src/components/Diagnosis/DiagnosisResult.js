                ...
                >
                    {props => (
                        <>
                            ...
                            <Flex style={props} alignItems="center" justifyContent="center" flexDir="column" w="30%" style={props}>
                                <Text fontSize="lg">Condition:</Text>
                                <Text fontSize="x-large" fontWeight="500">
                                    {diagnosisResult.condition}
                                </Text>
                            </Flex>
                            <Flex alignItems="center" justifyContent="center" flexDir="column" w="30%" style={props}>
